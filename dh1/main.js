...
function init() {
    ...
    var object_color = "#0xffc752";
    var geometry, material, mesh;
    material = new THREE.MeshStandardMaterial({ color: "#0xffc752" });
    ...
    var pointLight = getPointLight(0xffffff, 2, 200);
    ...
    $(".geometry").click(function () {
        ...
        switch (geometryName) {
            ...
            case "Tube":
                ...
                break;
            case "Heart":
                geometry = new THREE.ExtrudeGeometry(getHeart(), { amount: 1, bevelEnable: true, bevelSegments: 1, steps: 1, bevelSize: 0.5, bevelThickness: 1 });
        ...
        mesh.name = "geometry";
        mesh.material.color.setHex( 0xffc752 );
        mesh.position.y = 5
    ...
    addColorGUI(material, "Geometry Color", { color: 0xffc752 }, colorGUI);
    colorGUI.open();
    ...
    addColorGUI(pointLight, "Light Color", { color: 0x6d5d5d }, lightGUI);
    lightGUI.open();
...
function getPointLight(color, intensity, distance) {
    ...
    pointLight.position.set(40, 25, 10);
